...
public class SumResponsePlayerTest {
	...
	public void testFindAppropriateMove() {
		...
		int index2 = ResponsePlayer.levelTwoEncodedIndex(history2, history1, Colors.BLACK);
		int index1 = ResponsePlayer.levelOneEncodedIndex(history1, Colors.BLACK);
		...
		assertEquals(move2, player.bestMove());
	}
