...
public class Lgrf2PlayerTest {
	...
	@Test
	public void testNestedPolicies() throws Exception {
		player.setProperty("threads", "4");
		player.reset();
		Policy policy = ((McRunnable) (player.getRunnable(2))).getPolicy();
		assertSame(Lgrf2Policy.class, policy.getClass());
		assertSame(Lgrf1Policy.class, policy.getFallback().getClass());
		assertSame(EscapePolicy.class, policy.getFallback().getFallback()
				.getClass());
	}
