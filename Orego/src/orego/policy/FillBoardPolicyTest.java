...
//			assertTrue(policy.hasAllVacantNeighbors(at("a1"), board));
//			assertTrue(policy.hasAllVacantNeighbors(at("t1"), board));
//			assertTrue(policy.hasAllVacantNeighbors(at("t19"), board));
