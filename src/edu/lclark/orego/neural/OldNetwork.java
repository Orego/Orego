...
public class OldNetwork {
	 ...
	 * neuron.
	 */
	public OldNetwork(int inputSize, int hiddenNeuronSize, int hiddenLayers) {
	 ...
	 * neuron.
	 */
	public OldNetwork(int inputSize, int hiddenNeuronSize, int hiddenLayers, int outputs) {
		inputs = new InputNeuron[inputSize + 1];
		for (int i = 0; i < inputSize + 1; i++) {
			inputs[i] = new InputNeuron();
		}
