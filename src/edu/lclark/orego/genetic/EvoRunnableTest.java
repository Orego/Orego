...
public class EvoRunnableTest {
	...
	public void testPerformPlayout() {
		final Population[] populations = {new Population(5, 10, coords, runnable, BLACK), new Population(5, 10, coords, runnable, WHITE)};
	...
	public void testNextGene() {
		String[] diagram = {
				...
				"O...O", };
		player.getBoard().setUpProblem(diagram, BLACK);
		int gene = runnable.nextGene(BLACK);
