...
public class ExperimentConfiguration {
	...
	public static final int GAMES_PER_CONDITION = 96;
...
//		CONDITIONS[5] = "threads=2 book=LateOpeningBook compare-rest compare-rest-conf=0.99 early-exit-mult=2.0";
		CONDITIONS[0] = "threads=2 book=LateOpeningBook compare-second compare-second-conf=0.75";
		CONDITIONS[1] = "threads=2 book=LateOpeningBook compare-second compare-second-conf=0.80";
//		CONDITIONS[8] = "threads=2 book=LateOpeningBook compare-second compare-second-conf=0.85";
