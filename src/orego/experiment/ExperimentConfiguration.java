...
public class ExperimentConfiguration {
	...
	public static final String RESULTS_DIRECTORY = "/Users/Sam/Desktop/results/";
	...
	public static final String JAVA_WITH_OREGO_CLASSPATH = "java -ea -cp /Users/Sam/Documents/workspace/Orego/bin";
...
//			"n003.bw01.lclark.edu", "n004.bw01.lclark.edu" };
	...
	static {
		int i = 0;
		for (int msec = 2000; msec <= 4000; msec *= 2) {
			CONDITIONS[i] = "threads=2 msec=" + msec + " book=FusekiBook heuristics=Escape@60:Pattern@25:Capture@15";
			i++;
		}
	}
